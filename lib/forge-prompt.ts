...
const moduleRules: ModuleRule[] = [
  ...
  { id: 'automotive-suspension', matches: ({ text }) => /suspension|coil[- ]?over|wishbone/.test(text) && !isMotorcycleGoal(text) && !isBicycleGoal(text), compose: addAutomotiveSuspension },
