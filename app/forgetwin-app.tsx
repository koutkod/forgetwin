...
const EXPORT_OPTIONS: Array<{ format: ForgeExportFormat; title: string; extension: string; description: string; icon: 'image' | 'report' | 'cad' | 'data' }> = [
  ...
  { format: 'png-fallback', title: 'Verified CPU PNG', extension: '.PNG · 1800 × 1200 · NO WEBGL', description: 'Guaranteed visible engineering projection for browsers, judges, or devices where WebGL capture is unavailable.', icon: 'image' },
